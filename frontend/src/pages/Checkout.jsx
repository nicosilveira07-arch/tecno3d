...
if (cart.length === 0) {
return ( <section className="min-h-screen bg-zinc-950 px-6 py-10"> <div className="mx-auto max-w-7xl">
...
"token"
  ...
  try {
    ...
    // ==================================================
    //
    // La operación de checkout ya fue iniciada
    // correctamente. El carrito no debe quedar
    // disponible para generar otra sesión accidental.
    // ==================================================
